...
var welive_c = '<div id="welive_online">' + '<img src='+welive_url+'public/img/small_ck.png id="welive_tg3">' + '</div>' + '<div id="welive_wrap">' + '<div id="welive_drag"></div>' + '<div id="welive_mouse_tracker"></div>' + '<div id="welive_close"></div>' + '<div id="welive_close_btn"></div>' + '<div id="welive_iwrap">' + '<div id="welive_iholder"><iframe id="welive_iframe" src="" frameborder="0" scrolling="no" allowTransparency="true"></iframe></div>' + '</div>' + '</div>';
...
var welive_opened = 0,
	...
	welive_tg3 = $_$("welive_tg3"),
	welive_online = $_$("welive_online");
// var url = window.location.href;
var url = 'http"//wx.data.cma.cn:8090/kefu/';
$_$("welive_iframe").src = welive_url + "welive1618.php?a=321456978&r=" + Math.random() + "&url=" + url.replace(/&/g, "||4||");
